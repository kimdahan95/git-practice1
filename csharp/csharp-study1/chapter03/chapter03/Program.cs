...
// 5) int   -> signed   (부호가 있는 (+,-) 32비트 정수) -> -2,147,483,648 ~ 2,147,438,647
...
// 9) ulong -> unsigend (부호가 없는 (+,-) 64비트 정수) -> 0 ~ 18,446,744,073,709,551,615
...
class Program
{
    static void Main(string[] args)
    {
        ...
        sum = n1 + n2;   // 50 + 100이어서 sum에는 150
        sum = 14;        // 이전에 저장된 n1 + n2 값이 지워지고 14라는 값이 저장
        
        Console.WriteLine(sum); // 출력결과 150 -> 14로 바뀜

        // int,long등 기본 타입에 대한 C#의 별칭 (class)
        //  ex ) int -> System.Int32
        //       uint -> System.UInt32
        //사용 예제
        System.Int32 c1 = 50; // int c1 = 50;
        System.Int32 c2;
        c2 = 100;

        System.Int32 sum2 = c1 + c2;
        Console.WriteLine(sum2); //150
